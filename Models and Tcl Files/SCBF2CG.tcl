...
# GRAVITY COLUMNS
element elasticBeamColumn  602300     233     331 130.0000 $E [expr (786.5000  + 106.8000)] $trans_PDelta; element elasticBeamColumn  602400     243     341 130.0000 $E [expr (786.5000  + 106.8000)] $trans_PDelta; 
element elasticBeamColumn  601300     133     231 130.0000 $E [expr (786.5000  + 106.8000)] $trans_PDelta; element elasticBeamColumn  601400     143     241 130.0000 $E [expr (786.5000  + 106.8000)] $trans_PDelta; 

# GRAVITY BEAMS
element elasticBeamColumn  503200     334     342 244.5000 $E [expr $Comp_I_GC * 20400.0000] $trans_PDelta;
element elasticBeamColumn  502200     234     242 244.5000 $E [expr $Comp_I_GC * 20400.0000] $trans_PDelta;

# GRAVITY COLUMNS SPRINGS
Spring_IMK   903301     330     331 $E $fy [expr (786.5000 + 106.8000)] 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 16967.2250 0 $Composite 0 2; Spring_IMK   903401     340     341 $E $fy [expr (786.5000 + 106.8000)] 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 16967.2250 0 $Composite 0 2; 
Spring_IMK   902303     230     233 $E $fy [expr (786.5000 + 106.8000)] 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 16967.2250 0 $Composite 0 2; Spring_IMK   902403     240     243 $E $fy [expr (786.5000 + 106.8000)] 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 16967.2250 0 $Composite 0 2; 
Spring_IMK   902301     230     231 $E $fy [expr (786.5000 + 106.8000)] 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 16967.2250 0 $Composite 0 2; Spring_IMK   902401     240     241 $E $fy [expr (786.5000 + 106.8000)] 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 16967.2250 0 $Composite 0 2; 
Spring_IMK   901303     130     133 $E $fy 106.8000 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 2456.3000 0 $Composite 0 2; Spring_IMK   901403     140     143 $E $fy 106.8000 14.0000 27.5000 6.9700 2.4600 120.0000 60.0000 120.0000 2456.3000 0 $Composite 0 2; 

# GRAVITY BEAMS SPRINGS
set gap 0.08;
Spring_Pinching   903304     330     334 122512.5000 $gap 1; Spring_Pinching   903402     340     342 122512.5000 $gap 1; 
Spring_Pinching   902304     230     234 122512.5000 $gap 1; Spring_Pinching   902402     240     242 122512.5000 $gap 1; 
